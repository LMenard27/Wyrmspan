public class GameBoard {
   ...
   /*
   Shuffles the Dragon deck by calling the ShuffleStack method on it.
   */
   ...
   /*
   Shuffles the Cave deck by calling the ShuffleStack method on it.
   */
   ...
   /*
   Getter for the guild cycle rewards

   Return:
   the array of Resources representing the guild cycle rewards.
   */
   ...
   */
   ...
   Return:
   the array of Dragons representing the current Dragon shop.
   */
   ...
   Return:
   the array of Caves representing the current Cave shop.
   */
   ...
   Return:
   the Dragon at the top of the Dragon deck.
   */
   ...
   Return:
   the Cave at the top of the Cave deck.
   */
   ...
   Parameters:
   newDeck: the new Stack of Dragons to set as the Dragon deck.
   */
   ...
   Parameters:
   newDeck: the new Stack of Caves to set as the Cave deck.
   */
